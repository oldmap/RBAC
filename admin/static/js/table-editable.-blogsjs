var TableEditable = function () {
    ...
    return {
        ...
        init: function () {
            ...
            function editRow(oTable, nRow, user_id) {
                ...
                jqTds[5].innerHTML = '<a class="edit" href="" url=' + user_id + '>Save</a>';
            ...
            function saveRow(oTable, nRow, user_id) {
                ...
                if(user_id == "undefined"){  // 若未获取到user_id，则表示新增，
                     var url = "/api/users/";
                     var type = 'POST';
            ...
            $('#sample_editable_1 a.edit').live('click', function (e) {
                ...
                if (nEditing !== null && nEditing != nRow) {
                    ...
                    restoreRow(oTable, nEditing);
                    editRow(oTable, nRow, user_id);
                    nEditing = nRow;
                } else if (nEditing == nRow && this.innerHTML == "Save") {
                    /* Editing this row and want to save it */
                    // 获取
                    saveRow(oTable, nEditing, user_id);
                    nEditing = null;
